...
<html>
  ...
  <body class="easyui-layout">
	...
	<div data-options="region:'south',split:true,border:false" style="height: 30px;overflow:hidden;">
		<div class="panel-header" style="border: none;text-align: center;" >CopyRight &copy; 2016       版权所有. </div>
	</div>
	<!-- 中间内容页面 -->
	<div data-options="region:'center'" >
		<div class="easyui-tabs" id="tab-box" data-options="fit:true,border:false">
			<div title="公告栏" style="padding:20px;overflow:hidden;"> 
				...
				<div style="margin-top:20px;">
					...
					<p>  &nbsp;&nbsp;</p>
					<ul>
						<li>客服邮箱：hlf@hangtoo.com</li> 
						<li>技术支持：hangtoo科技</li> 
					</ul>
				</div>
