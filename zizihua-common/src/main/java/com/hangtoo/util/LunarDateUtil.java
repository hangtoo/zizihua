...
public class LunarDateUtil {
	...
	public static Date solarTolunar(String shortdate) throws ParseException {
		LunarDateUtil util=new LunarDateUtil(DateUtils.parseDate(shortdate,DateUtils.pattern_d));
		return util.getDate();
	}
